...
```bash
npm install @tanstack/react-table@"^9" react@">=18"
```

| Package | Range | Why |
|---|---|---|
| `@tanstack/react-table` | `^9` | tablecraft wraps its row model, column, and state APIs. TanStack Table v8 is no longer supported — see the [v4 migration guide](/docs/migrating-v4) if you are upgrading from a v8-based tablecraft 3.x. |
