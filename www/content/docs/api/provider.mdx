...
| `columnOrder` | `ColumnOrderOptions \| boolean` | Enable column ordering by default |
| `rowPinning` | `RowPinningOptions \| boolean` | Enable row pinning by default |
| `columnResizing` | `ColumnResizingOptions \| boolean` | Enable column resizing by default |
