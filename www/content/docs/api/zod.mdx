...
const columns = columnsFromZod(userSchema)   // ColumnDef<TablecraftFeatures, User, any>[]
...
| `overrides` | `Partial<Record<keyof TData, Partial<ColumnDef<TablecraftFeatures, TData, any>>>>` | Override specific column definitions while keeping the rest generated |
